...
|--------|-------------------|---------|
| Azure DevOps | `azureDevOps` | Interact with Azure DevOps: repositories, pull requests, pipelines, work items, wikis |
...
|----------|-------------|---------|
| `AZURE_DEVOPS_ORG_URL` | URL to your Azure DevOps organization/collection | `http://hcm-srv-tfscore01:8080/tfs/DefaultCollection` |
...
1. Open your Azure DevOps in a browser and navigate to:
   ```
