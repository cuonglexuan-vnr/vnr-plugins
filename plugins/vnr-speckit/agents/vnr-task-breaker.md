...
| `vnr-speckit/standards/backend/02-architecture-and-structure.md` | Naming conventions, file path patterns |
...
Tạo `specs/<feature>/tasks.md` theo template `vnr-speckit/templates/tasks-template.md`.
