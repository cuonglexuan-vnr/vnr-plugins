...
| `vnr-speckit/standards/backend/02-architecture-and-structure.md` | Clean Architecture, CQRS patterns |
| `vnr-speckit/standards/backend/03-permission.md` | `[CheckAccess]`, permission keys |
| `vnr-speckit/standards/frontend/02-architecture-and-structure.md` | Angular structure, Module Federation |
| `vnr-speckit/standards/frontend/03-permission.md` | Permission directive, AuthGuard |
