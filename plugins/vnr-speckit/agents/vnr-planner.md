...
| `vnr-speckit/standards/backend/01-tech-stack.md` | Stack kỹ thuật BE |
| `vnr-speckit/standards/backend/02-architecture-and-structure.md` | Clean Architecture, CQRS, Service Slice layout |
| `vnr-speckit/standards/backend/03-permission.md` | Bitwise privilege, `[CheckAccess]`, Redis cache |
| `vnr-speckit/standards/frontend/01-tech-stack.md` | Stack kỹ thuật FE |
| `vnr-speckit/standards/frontend/02-architecture-and-structure.md` | Micro-frontend, Module Federation |
| `vnr-speckit/standards/frontend/03-permission.md` | Signal-based permission, AuthGuard |
...
Tạo `specs/<feature>/plan.md` theo template `vnr-speckit/templates/plan-template.md`:
- **Technical Context**: stack, service slice, bounded context.
- **Constitution Check**: tham chiếu `vnr-speckit/memory/constitution.md`.
