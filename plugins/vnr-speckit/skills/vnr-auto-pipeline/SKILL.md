...
| 2 | vnr-qc-generator | `vnr-speckit/agents/vnr-qc-generator.md` | Agent tool |
...
| 5 | vnr-arch-reviewer | `vnr-speckit/agents/vnr-arch-reviewer.md` | Agent tool (song song) |
| 6 | vnr-sec-reviewer | `vnr-speckit/agents/vnr-sec-reviewer.md` | Agent tool (song song) |
